...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, DEBUG_LED_Pin|MOTOR_DIR_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DEBUG_LED_Pin MOTOR_DIR_Pin */
  GPIO_InitStruct.Pin = DEBUG_LED_Pin|MOTOR_DIR_Pin;
